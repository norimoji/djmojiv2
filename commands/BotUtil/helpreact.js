...
module.exports = class helpReactionCommand extends Command {
	constructor(client) {
		super(client, {
			name: 'helpreact',
			group: 'bot utility',
			memberName: 'helpreact',
			description: 'Bot sends you help reaction functionality.',
		});
	}
	...
	async run(message) {
		...
		this.client.registry.findGroups('reaction command').forEach((fields) => {
